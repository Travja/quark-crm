...
{#each data.orders as order}
  <span>
    <div class="column">
      ...
      <StyledInput id="artist" name="artist" bind:value={order.artist} />
    ...
    <div class="column">
      ...
      <StyledInput id="tree-type" name="tree-type" bind:value={order.type} />
    ...
    <div class="column triple-column">
      ...
      <StyledInput id="roots" name="roots" bind:value={order.roots} />
      <StyledInput
        id="rootsValue"
        name="rootsValue"
        type="number"
