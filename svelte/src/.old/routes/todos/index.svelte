<script lang="ts">
    ...
    window.api.fileSystem.send("readFile", fileName);
    window.api.fileSystem.receive("getFile", (data) => {
        todos = [...data];
    });
    ...
    function saveTodos() {
        ...
        window.api.fileSystem.send("saveFile", data);
    }
</script>
